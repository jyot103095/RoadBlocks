...
class Game {
  ...
  getHorizontalPosition(position) {
    ...
    // this.blocks.forEach(block => {
    //   if ((this.snake.positionY - 10) < (block.positionY + block.width) && (this.snake.positionY + 10) > block.positionY) {
    //     if (this.checkLeft(newPosition, block)) {
    //       newPosition = block.positionX + block.width + 10;
    //     } else if (this.checkRight(newPosition, block)) {
    //       debugger
    //       newPosition = block.positionX - 10;
    //     }
    //   }
    // });
