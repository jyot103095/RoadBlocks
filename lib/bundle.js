...
class Game {
  constructor() {
    ...
    this.velocity = 4;
    this.blocks = [ new _block__WEBPACK_IMPORTED_MODULE_2__["default"](0, this.velocity),
      new _block__WEBPACK_IMPORTED_MODULE_2__["default"](180, this.velocity), new _block__WEBPACK_IMPORTED_MODULE_2__["default"](270, this.velocity), new _block__WEBPACK_IMPORTED_MODULE_2__["default"](360, this.velocity) ];
  }
  ...
  gameOver() {
    return !this.snake || this.snake.length === 0;
  }
...
class GameView {
  ...
  animate(time) {
    ...
    if (this.game.gameOver()) {
      ...
      document.removeEventListener("mousemove", game.moveSnake);
    } else {
      requestAnimationFrame(this.animate.bind(this));
    }
  }
