...
class Game {
  ...
  generateBlocks() {
    ...
    positionsArr.forEach(pos => {
      let newBlock = new _block__WEBPACK_IMPORTED_MODULE_2__["default"](pos, this.getRandomValue());
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/home/jyotpatel/Desktop/RoadBlocks/lib/lengthBall.js'");
